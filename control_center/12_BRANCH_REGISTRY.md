...
| Build-Backend | 后端执行 | FastAPI、解析、抽取、整合、RAG、反馈接口 | `06_MVP_DECISION_BOARD.md`, `18_PHASE_TASK_BREAKDOWN.md` | 可运行 API、数据结构、样例结果 | 不一开始处理全量 824MB；不改前端主布局 | `09_TASK_TREE.md`, `10_HANDOFF.md`, `15_MERGE_QUEUE.md` | Waiting |
...
| Report | 技术报告 | 飞书技术报告和加分说明 | `05_TECH_REPORT_TEMPLATE.md`, `11_SUBMISSION_URL_GUIDE.md` | 可公开访问的报告链接 | 不写无法验证的夸张描述 | `04_SUBMISSION_CHECKLIST.md`, `15_MERGE_QUEUE.md` | Waiting |
