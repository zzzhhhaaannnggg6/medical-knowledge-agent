...
- 2026-05-10 Build-Backend 分支完成 FastAPI 后端：`/health`、`/api/demo/load`、`/api/documents`、`/api/state`、`/api/rag/query`、`/api/feedback`；本地 smoke test 在 `http://127.0.0.1:8001` 通过
- 2026-05-10 10:14 Docs/Report 分支补齐评分文档和技术报告草稿，记录 smoke test 数据：2 本教材、20 章节、121 节点、186 边、24 决策、压缩比 4.07%、1 条模拟反馈事件
...
- 端口 `8000` 当前被本机 Python 进程占用；本分支验证使用 `8001`，Root/Frontend 如需 8000 需先确认该进程归属。
